...
public class GuideActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        viewPoints = (ViewGroup) viewPics.findViewById(R.id.LlayoutviewGroup);
        ...
        for(int i=0;i<pageViews.size();i++){
            ...
            if(i==0){
                imageViews[i].setBackgroundResource(R.drawable.shixinyuan);
            }else{
                imageViews[i].setBackgroundResource(R.drawable.kongxinyuan);
            }
    ...
    class GuidePageChangeListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            ...
            for(int i=0;i<imageViews.length;i++){
                imageViews[position].setBackgroundResource(R.drawable.shixinyuan);
